 ...
 * 
 * call_vs routine ...up to 3 args... -> (result)
 * 
 ...
 * false.)
 * 
 * TODO: Note: this is really the same as Call, really need to refactor
 * all the Calls.
 * 
 * @author <a href="mailto:iosdevx@gmail.com">Michael Zanussi</a>
 * @version 1.0 (7 July 2016) 
 */
public class Call_vs extends AbstractOpcode {
	 ...
	 */
	public Call_vs(Instruction instruction) {
		super(instruction);
		isStore = true;
		name = "call_vs";
	}
	...
	public void exec() {
		...
		if (routine_addr == 0) {
			assert (false) : "finish Call_vs exec for packed address 0";
		}
