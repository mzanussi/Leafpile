 ...
 */
public class LeafpileGUI extends JFrame {

	private Console console;
	
	private Menu menu;			// menu bar
	
//	private ZMachine zm;		// the virtual machine
	private Object zm;		// the virtual machine
...
//		zm.setDebug(debug);
        ...
        // Get the text ascent.
        //int text_ascent = metrics.getAscent();
		scr_height = 25;
		scr_width = 80;
...
//		zm.start();
	...
	public void setScreenModel() {
		...
		console = new V3ScreenModel(zm, scr_width, scr_height, font);
		console.init();
...
//		zm.setDebug(debug);
	...
	private class ZavFileFilter extends FileFilter {
		public boolean accept(File f) {
			return f.isDirectory() | (f.isFile() && f.getName().toLowerCase().endsWith(".zav"));
		}
